...
*  xref:wiki:netbeanstestfaq:TestingThingsThatUseFileObjectDataObjectDataFolder.adoc[Writing Tests with FileObjects, DataObjects, and DataFolders]
*  xref:wiki:netbeanstestfaq:DevFaqTestDataObject.adoc[Writing Tests with DataObjects and DataLoaders]
*  xref:wiki::wiki/InitializationOfDefaultLookup.adoc[Writing Tests with Lookup]
*  xref:wiki:netbeanstestfaq:DevFaqTestUsingSystemFileSystem.adoc[How do I test something which uses the System Filesystem?]
...
*  link:http://openide.netbeans.org/tutorial/test-patterns.html[Typical Test Patterns]
*  xref:wiki:netbeanstestfaq:NetBeansDeveloperTestFAQ.adoc[ NetBeans Developer Test FAQ]
*  link:http://blogs.oracle.com/coreqa/entry/xtest_is_dead_long_live[XTest is Dead Long Live Simpletests]
*  xref:wiki:performance:FitnessTestsWithoutX.adoc[FitnessTestsWithoutX]
*  xref:wiki:netbeanstestfaq:DevFaqUsingSimpletests.adoc[Using Simpletests]
...
*  xref:wiki:netbeanstestfaq:DevRunningTestsPlatformApp.adoc[Running tests on a platform application]
*  xref:wiki:netbeanstestfaq:TestingThingsThatUseFileObjectDataObjectDataFolder.adoc[ Testing things that use FileObjects]
*  xref:wiki:netbeanstestfaq:DevFaqTestDataObject.adoc[ Writing Tests for DataObjects and DataLoaders]
*  xref:wiki:netbeanstestfaq:DevFaqTestUsingSystemFileSystem.adoc[ How do I test something which uses the System Filesystem?]
