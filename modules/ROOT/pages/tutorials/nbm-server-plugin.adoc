...
For more information on working with NetBeans modules, see the  xref:kb/docs/platform.adoc[ NetBeans Module and Rich-Client Application tutorials page] on the NetBeans website. If you have questions, visit the  xref:wiki:netbeansdevelopperfaq:DevFaqIndex.adoc[ NetBeans Developer FAQ] or use the feedback link at the top of this page.
